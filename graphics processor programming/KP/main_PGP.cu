...
int main(int argc, char* argv[]) {
    ...
    MPI_Bcast(&frame_num, 1, MPI_INT, 0, MPI_COMM_WORLD);
    MPI_Bcast(path_to_image, 100, MPI_CHAR, 0, MPI_COMM_WORLD);
    MPI_Bcast(&w, 1, MPI_INT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&h, 1, MPI_INT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&angle, 1, MPI_INT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&rc0, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&zc0, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&phic0, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&acr, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&acz, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&wcr, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&wcz, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&wcphi, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&pcr, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&pcz, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&rn0, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&zn0, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&phin0, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&anr, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&anz, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&wnr, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&wnz, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&wnphi, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&pnr, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&pnz, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);

    MPI_Bcast(&center1_x, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&center1_y, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&center1_z, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&color1_x, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&color1_y, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&color1_z, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&r1, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&refl_1, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&tran_1, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&first_num, 1, MPI_INT, 0, MPI_COMM_WORLD);

    MPI_Bcast(&center2_x, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&center2_y, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&center2_z, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&color2_x, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&color2_y, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&color2_z, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&r2, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&refl_2, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&tran_2, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&second_num, 1, MPI_INT, 0, MPI_COMM_WORLD);

    MPI_Bcast(&center3_x, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&center3_y, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&center3_z, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&color3_x, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&color3_y, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&color3_z, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&r3, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&refl_3, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&tran_3, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&third_num, 1, MPI_INT, 0, MPI_COMM_WORLD);

    MPI_Bcast(&f1_x, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&f1_y, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&f1_z, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&f2_x, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&f2_y, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&f2_z, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&f3_x, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&f3_y, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&f3_z, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&f4_x, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&f4_y, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&f4_z, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);

    MPI_Bcast(path_to_floor, 100, MPI_CHAR, 0, MPI_COMM_WORLD);

    MPI_Bcast(&f_color_r, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&f_color_g, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&f_color_b, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&f_ref, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);

    MPI_Bcast(&lights_num, 1, MPI_INT, 0, MPI_COMM_WORLD);

    for (int i = 0; i < lights_num; i++) {
        cin >> l_pos_x >> l_pos_y >> l_pos_z;
        cin >> light_r >> light_g >> light_b;
        MPI_Bcast(&l_pos_x, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
        MPI_Bcast(&l_pos_y, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
        MPI_Bcast(&l_pos_z, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    }

    cin >> max_deep >> sqrt_ray_num;

    MPI_Bcast(&max_deep, 1, MPI_INT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&sqrt_ray_num, 1, MPI_INT, 0, MPI_COMM_WORLD);
	...
	for (int k = id; k < frame_num; k += numproc) {
        ...
        if (on_gpu) {
            kernel_render<<<dim3(32, 32), dim3(32, 32)>>>(pc, pv, w_smooth, h_smooth, angle, dev_data, dev_figures, figures.size(), light_source, light_shade);
            CSC(cudaGetLastError());

            kernel_ssaa<<<dim3(32, 32), dim3(32, 32)>>>(dev_data, dev_short_data, w, h, sqrt_ray_num);
            CSC(cudaGetLastError());
